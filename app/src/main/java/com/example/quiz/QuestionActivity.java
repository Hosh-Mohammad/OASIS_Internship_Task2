...
public class QuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions = new ArrayList<Question>(){
            {
                add(new Question("Whic is the value of iota?", "C", "3.1415", "1.7189","-1", "5.985"));
                add(new Question("Who is prayed by christians: \"\"?", "A", "Jesus", "Hitler","Mussolini", "Stalin"));
                add(new Question("Which is right term for buuiness?", "D", "Pedreiro", "Programador","Músico", "marketing"));
